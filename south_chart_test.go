...
func TestSouthChart_AllPlanets(t *testing.T) {
	// Test 1: All planets in different rashis
	input := ChartInput{
		ChartType: ChartTypeSouth,
		Lagna: &Planet{
			Rashi:        "aries",
			IsRetrograde: false,
			IsCombust:    false,
	...
	err = os.WriteFile("test_south_all_planets.png", imageData, 0644)
	if err != nil {
...
func TestSouthChart_AllPlanetsWithLagna(t *testing.T) {
	...
	err = os.WriteFile("test_south_all_planets_with_lagna.png", imageData, 0644)
	if err != nil {
		t.Fatalf("Error writing file: %v", err)
	}
...
func TestSouthChart_AllPlanetsWithUpagrahas(t *testing.T) {
	...
	err = os.WriteFile("test_south_all_planets_with_upagrahas.png", imageData, 0644)
	if err != nil {
		t.Fatalf("Error writing file: %v", err)
	}
...
func TestSouthChart_AllPlanetsUpagrahasLagnaSameRashi(t *testing.T) {
	...
	err = os.WriteFile("test_south_all_same_rashi.png", imageData, 0644)
	if err != nil {
		t.Fatalf("Error writing file: %v", err)
	}
...
func TestSouthChart_WithCenterText(t *testing.T) {
	// Test with center text including newlines
	input := ChartInput{
		ChartType: ChartTypeSouth,
		Lagna: &Planet{
			Rashi:        "scorpio",
	...
	err = os.WriteFile("test_south_with_center_text.png", imageData, 0644)
	if err != nil {
		t.Fatalf("Error writing file: %v", err)
	}

	t.Logf("Test with center text passed: Chart generated successfully (%d bytes)", len(imageData))
}
